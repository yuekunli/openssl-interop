...
namespace INTEROP_TEST_SYMMETRICCRYPT {
	...
	void test_Symmetric_Cipher()
	{
		...
		//test(ALGO::DES3_CBC, LIB::OPENSSL, LIB::OPENSSL, LIB::OPENSSL);     // not supported by FIPS, passed this test with default provider
		//test(ALGO::DES3_CBC, LIB::OPENSSL, LIB::OPENSSL, LIB::CRYPTOPP);    // not supported by FIPS, passed this test with default provider
		//test(ALGO::DES3_CBC, LIB::OPENSSL, LIB::CRYPTOPP, LIB::OPENSSL);    // not supported by FIPS, passed this test with default provider
