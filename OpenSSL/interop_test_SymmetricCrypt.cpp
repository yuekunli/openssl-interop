...
namespace INTEROP_TEST_SYMMETRICCRYPT {
	...
	void test_Symmetric_Cipher()
	{
		...
		//test(ALGO::DES3_CBC, LIB::OPENSSL, LIB::OPENSSL, LIB::OPENSSL);     // not supported by FIPS
		//test(ALGO::DES3_CBC, LIB::OPENSSL, LIB::OPENSSL, LIB::CRYPTOPP);    // not supported by FIPS
		//test(ALGO::DES3_CBC, LIB::OPENSSL, LIB::CRYPTOPP, LIB::OPENSSL);    // not supported by FIPS
