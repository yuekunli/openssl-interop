...
public class S3TransferProgressSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AWSCredentials credentials = new BasicAWSCredentials("minio-admin-user", "miniodeploy");

        ClientConfiguration clientConfiguration = new ClientConfiguration();
        clientConfiguration.setSignerOverride("AWSS3V4SignerType");

        AmazonS3 s3 = AmazonS3ClientBuilder.standard()
                .withEndpointConfiguration(new AwsClientBuilder.EndpointConfiguration("http://127.0.0.1:9000", Regions.US_WEST_1.name()))
        ...
        bucketName = "s3-upload-sdk-sample-" + UUID.randomUUID();
